			...
			<tr>
				...
				<td>
					...
					<table border="0" cellpadding="0" cellspacing="0" id="subtree8" style="DISPLAY: none" width="80%" align="right" class="left-table2">
						...
						<tr>
							<td width="9%" height="20"><img id="xiaotu23" src="../img/ico06.gif" width="8" height="12" /></td>
							<td width="91%"><a href="add admin.php" target="mainFrame"  onClick="tupian('23');">添加管理人员</a></td>
						</tr>
						<tr>
