			...
			<fieldset>
				...
				<table width="95%" border="0" cellpadding="2" cellspacing="0" align="center">
					...
					<form action="../php/addTeam.php" method="post" enctype="multipart/form-data">
						...
						<tr>
							<td align="right" width="5%">级别：</td>
							<td width="16%" class="aa"><input style="width:200px" type="text" size="40" id="rank" name="rank" class="input" required="required"/><span class="red"> *</span></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2" align="right" height="100px">
								<input type="submit" name="Submit" value="添加" class="button" onclick="submit();" />
