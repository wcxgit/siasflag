			...
			$.ajax({
				...
				success:function (data) {
					...
					$.each(list, function(index,array){
						dataStr += '<tr bgcolor="#FFFFFF" align="center" class="az"><td>'+array['name']+
						'</td><td>'+array['message']+'</td><td class="ad">'+array['time']+
						'</td><td class="ad"><a href="javascript:;" onclick="getAsk('+array['id']+
						');">查看回复</a></td></tr>';
				});
					$('#list').append(dataStr);
